...
This repository tracks upstream [njbrake/agent-of-empires](https://github.com/njbrake/agent-of-empires) and keeps fork-specific behavior documented in [docs/fork-features/](docs/fork-features/index.md), including branch labels, session archive, tool session restore, terminal tab titles, session summaries in the TUI preview panel, and Codex status detection fixes.
