...
base("desktop: re-selecting the active terminal session refocuses the textarea", async ({ page }, testInfo) => {
  ...
  try {
    ...
    await expect.poll(() => activeElementInXterm(page), { timeout: 10_000 }).toBe(true);
